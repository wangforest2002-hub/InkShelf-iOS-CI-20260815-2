...
- 2.4.0 新增可切换的纸张翻页动效，横向画集带有跟手透视、书脊阴影和页缘高光；统一书架、画廊、弹层与阅读工具栏的动效节奏，并自动适配系统“减少动态效果”。
...
```powershell
.\scripts\Publish-OnlineUpdate.ps1 -SignedIpa "D:\path\二次元小家-signed.ipa" -Version "2.4.0" -Build 24 -Notes "新增跟手纸张翻页与统一动效","修复快速翻页后的页码回跳","稳定 PDF 双页与进度条同步"
```
