...
- 2.4.1 将分页手势的最终落点限制在相邻单页/双页组，快速横划也会稳定按 1、2、3、4 顺序阅读，不再跨成 1、3、5、7。
...
```powershell
.\scripts\Publish-OnlineUpdate.ps1 -SignedIpa "D:\path\二次元小家-signed.ipa" -Version "2.4.1" -Build 25 -Notes "修复横向快速划动偶尔跨页","每次手势稳定前进或后退一个分页单元"
```
